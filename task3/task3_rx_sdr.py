...
class task3_rx_sdr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "task3_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("task3_rx")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "task3_rx_sdr")
        ...
        # Variables
        ##################################################
        self.udp_payload = udp_payload = 1316
        self.sps = sps = 4
        self.samp_rate = samp_rate = 2e6
        self.rx_gain = rx_gain = 30
        self.center_freq = center_freq = 433e6
        self.bit_skip = bit_skip = 0
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_char, 1, '127.0.0.1', 6001, 0, udp_payload, False)
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, bit_skip)
        ...
        self.connect((self.digital_gmsk_demod_0, 0), (self.blocks_skiphead_0, 0))
        self.connect((self.soapy_rtlsdr_source_0, 0), (self.analog_agc_xx_0, 0))
    ...
    def get_udp_payload(self):
        return self.udp_payload

    def set_udp_payload(self, udp_payload):
    ...
    def get_bit_skip(self):
        return self.bit_skip

    def set_bit_skip(self, bit_skip):
        self.bit_skip = bit_skip




def main(top_block_cls=task3_rx_sdr, options=None):
