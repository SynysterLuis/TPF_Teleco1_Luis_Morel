...
class task3_tx_hackrf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "task3_tx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("task3_tx")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "task3_tx_hackrf")
        ...
        self.network_udp_source_0 = network.udp_source(gr.sizeof_char, 1, 6000, 0, udp_payload, False, False, False)
...
def main(top_block_cls=task3_tx_hackrf, options=None):
