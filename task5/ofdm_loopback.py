...
class ofdm_loopback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM - Task5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM - Task5")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ofdm_loopback")
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Señal recibida en el tiempo", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.network_udp_source_0 = network.udp_source(gr.sizeof_char, 1, 6000, 0, packet_len, False, False, False)
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_char, 1, '127.0.0.1', 6001, 0, 1316, False)
        self.digital_ofdm_tx_0 = digital.ofdm_tx(
            fft_len=64,
            cp_len=16,
            packet_length_tag_key=len_tag_key,
            occupied_carriers=((-3, -2, -1, 1, 2, 3, 4),),
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_throttle2_0, 0))
...
def main(top_block_cls=ofdm_loopback, options=None):
