...
class Task2_GMSK_Video(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Video GMSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Video GMSK")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Task2_GMSK_Video")
        ...
        self._noise_range = qtgui.Range(0, 0.2, 0.005, 0, 200)
        ...
        self.connect((self.network_udp_source_0, 0), (self.digital_gmsk_mod_0, 0))
...
def main(top_block_cls=Task2_GMSK_Video, options=None):
